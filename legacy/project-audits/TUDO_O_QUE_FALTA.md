...
> os documentos em `../../next-app/docs/`.
...
| **legacy/pb-hooks/pixgo.pb.js:** rotas PIX e confirm-and-apply no PocketBase. | Next tem rotas em /api/payments/pix e webhook; lógica de “aplicar plano + expiração” no webhook está incompleta. |
