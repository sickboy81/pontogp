...
const page = findSeoNearMePage('acompanhantes-perto-de-mim')

export const metadata: Metadata = {
  title: page?.title,
  description: page?.description,
  alternates: { canonical: `${SITE_URL}/acompanhantes-perto-de-mim` },
  robots: {
    index: true,
    follow: true,
...
export default function AcompanhantesPertoDeMimPage() {
