...
const page = findSeoNearMePage('massagistas-perto-de-mim')

export const metadata: Metadata = {
  title: page?.title,
  description: page?.description,
  alternates: { canonical: `${SITE_URL}/massagistas-perto-de-mim` },
  robots: {
    index: true,
    follow: true,
...
export default function MassagistasPertoDeMimPage() {
