...
test('public user profile excludes private account fields', () => {
  assert.deepEqual(toPublicUserProfile({ id: 'u1', name: 'Cliente', email: 'private@example.com', avatar: 'a.jpg', role: 'user', created: '2026-01-01 10:00:00' }), {
    id: 'u1', name: 'Cliente', avatar: 'a.jpg', created: '2026-01-01 10:00:00', role: 'user',
  })
})
